...
public class ReviewController {
	...
	// 指定された民宿のレビューをページングされた状態で取得し、民宿詳細ページへ受け渡して表示する。
	@GetMapping
	...
	// register レビュー投稿ページを表示する。
	// レビュー投稿ページ用フォームクラスのインスタンスを生成し、指定された民宿のデータとともに受け渡す。
	@GetMapping("/register")
	...
	//	create	createReview()メソッドを用いて、新しいレビューを登録する。
	// フォームのバリデーションNGの場合は、レビュー投稿ページを再表示。
	@PostMapping("/create")
	...
	//	edit	レビュー編集ページを表示する。
	// レビュー編集ページ用フォームクラスのインスタンスを生成し、指定された民宿・レビューのデータとともに受け渡す。
	...
	// update	updateReview()メソッドを用いて、指定されたレビューを更新する。
    // フォームのバリデーションNGの場合は、レビュー編集ページを再表示。
    ...
    //	delete	deleteReview()メソッドを用いて、指定されたレビューを削除する。
